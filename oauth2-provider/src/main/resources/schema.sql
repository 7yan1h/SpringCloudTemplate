CREATE TABLE `oauth2_client_details`  (
  ...
  `web_server_redirect_uri` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '授权后，重定向url',
...
-- ----------------------------
INSERT INTO `oauth2_client_details` VALUES (1, 'hx-client', 'id1,id2', '$2a$10$SWnBBm.eWhc3wKxycu7j5uD9PwErS3fg4PpuOd2yqK8GL.4/3r7gu', 'app,web', 'authorization_code,refresh_token', 'http://www.baidu.com', 'CLIENT_ADD,CLIENT_DELETE', 1800, 604800, NULL, '', 1, 'robot', '2019-10-13 23:51:14', NULL, NULL, NULL);